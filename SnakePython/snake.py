...
font=pygame.font.SysFont('Courier New (Courier)',40)
    ...
    while 1:
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                main()
        WIN.fill((110, 110, 5))
        main_menu_message = font.render('Start Button / Press any key to start' , True , (255,255,255))
...
def main():
    ...
    while 1:
        ...
        for square in snake_body:
            pygame.draw.rect(WIN ,(108, 156, 171), (square[0],square[1],10,10))
        if direction == 'right':
            snake_pos[0] += 10
        elif direction == 'left':
            snake_pos[0] -= 10
        ...
        pygame.draw.rect(WIN ,(247, 17, 29),(fruit_pos[0],fruit_pos[1],10,10))
